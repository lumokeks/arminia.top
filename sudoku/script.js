...
(function() {
    ...
    document.querySelector(".icon.help").addEventListener("click", () => _c13({title: "[ Sudoku Solver | Help ]", data: "\"<b>=</b>\": tries to solve | \"<b>AC</b>\" to clear grid | \"<b><=</b>\" to clear cell<br>> click on any cell to select it<br>> keyboard numbers are supported aswell<br>&nbsp;&nbsp;- enter <b>0</b> to skip selected cell<br>> \"<b>map</b>\" shows a flat map of the grid<br>&nbsp;&nbsp;- you can enter your own flat map aswell to translate it onto the grid<br><br>\"latency\" is the time it takes for \"Solving Sudoku...\" to fully unfold, otherwise it'd get stuck in the middle of the animation (due to the solving algorithm having already started)"}).show());
})();
